...
import {Grid, Paper, Box, Typography, Card, CardContent, CardMedia, Switch} from '@material-ui/core';
    ...
    return (
        <Box bgcolor='secondary.main' mt={6} m={5} p={5} className={classes.root} display='flex' justifyContent='center' alignItems='center'>
            <Paper className={classes.container} elevation={24} variant='elevation' >
                <Box display='flex' justifyContent='center' alignItems='center' className={classes.height100}>
                    <Grid item xs={6} className={classes.height100}>
                            ...
                            <CardContent className={classes.height100}>
                                <Box className={classes.height100}>
                                    <Box display='flex' justifyContent='flex-end' alignItems='center'>
                                        <Typography variant="span" color="initial">Sign in</Typography>
                                        <Switch
                                        color='primary'
                                        checked={switchState}
                                        onChange={() => setSwitchState(!switchState)}
                                        />
                                        <Typography variant="body1" color="initial">Sign up</Typography>
                                    </Box>
                                    {
