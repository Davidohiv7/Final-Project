...
export default function Orders() {
    ...
    const rows = orders && orders.map((order) => createData(order.id, order.total, order.status, <Button onClick={() => {}}className= {classes.editButton}><img width='25px' src={edit}></img></Button>))
    return (
